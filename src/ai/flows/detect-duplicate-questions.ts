...
You are an expert in identifying conceptually duplicate trivia questions.
...
- Ignore minor differences in phrasing, sentence structure, or the specific entities mentioned if the core query is identical (e.g., "What is the capital of France?" is a duplicate of "Paris is the capital of which country?").
